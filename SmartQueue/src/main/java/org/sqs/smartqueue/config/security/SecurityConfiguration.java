...
import org.sqs.smartqueue.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .csrf(csrf -> csrf
                        ...
                        .ignoringRequestMatchers("/api/auth/login", "/api/auth/register", "/api/auth/oauth2/**", "/api/auth/oauth/exchange", "/api/auth/logout", "/api/kafka/**")
